package dcrew.rs2.content.dwarfcannon;

import dcrew.core.cache.map.Region;
import dcrew.core.task.TaskQueue;
import dcrew.core.task.impl.ForceMovementTask;
...
public class DwarfMultiCannon {
	...
	public static final boolean isCannonSetupClear(Player player) {
		...
		int x2 = x + dcrew.rs2.GameConstants.DIR[3][0];
		int y2 = y + dcrew.rs2.GameConstants.DIR[3][1];
