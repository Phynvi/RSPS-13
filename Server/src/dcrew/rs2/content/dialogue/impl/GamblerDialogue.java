...
public class GamblerDialogue extends Dialogue {
	public GamblerDialogue(Player player) { this.player = player; }
    ...
    public void execute() {
       switch (next) {
       case 0:
    	   DialogueManager.sendNpcChat(player, 1011, Emotion.HAPPY_TALK, "Hello " + player.getUsername() + "!", ("I am in charge of all gambling done in " + Constants.name));
    	   next++;
    	   break;
       case 1:
