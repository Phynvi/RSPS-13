...
public class DuelingController extends Controller {
	...
	public Location getRespawnLocation(Player player) {
		Location p = DuelingConstants.RESPAWN_LOCATIONS[dcrew.core.util.Utility.randomNumber(DuelingConstants.RESPAWN_LOCATIONS.length)];
		int[] dir = dcrew.rs2.GameConstants.DIR[dcrew.core.util.Utility.randomNumber(dcrew.rs2.GameConstants.DIR.length)];
