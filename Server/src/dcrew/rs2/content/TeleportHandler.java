...
import dcrew.rs2.content.minigames.clanwars.ClanWarsConstants;
import dcrew.rs2.content.minigames.weapongame.WeaponGameConstants;
...
public class TeleportHandler {
	static final String[] trainingTPs = {
			"Rock Crabs",
			"Hill Giants",
			"Cows",
			"Yaks"
	...
	public enum TeleportationData {
		...
		public boolean getSpecialCase() { return specialCase; }
