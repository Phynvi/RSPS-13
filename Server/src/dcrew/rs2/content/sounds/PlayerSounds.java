package dcrew.rs2.content.sounds;

import dcrew.core.util.GameDefinitionLoader;
import dcrew.rs2.entity.Sound;
...
public class PlayerSounds {
	...
	public static void sendBlockOrHitSound(Player player, boolean hit) {
		...
		if ((shield != null) && (sounds[shield.getId()] != null)) {
			player.getClient().queueOutgoingPacket(new SendSound(sounds[shield.getId()][dcrew.core.util.Utility.randomNumber(sounds[shield.getId()].length)].id, 0, 0));
		}
