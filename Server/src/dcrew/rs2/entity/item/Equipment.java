...
import dcrew.rs2.content.skill.ranged.RangedConstants;
...
import dcrew.rs2.entity.item.EquipmentConstants.WeaponAttackStyles;
		...
		if (requirements != null) {
			...
			for (byte[] requirement : requirements) {
				if (player.getMaxLevels()[requirement[0]] < requirement[1]) {
					String name = dcrew.rs2.content.skill.Skills.SKILL_NAMES[requirement[0]];
