...
import dcrew.core.cache.map.Doors;
import dcrew.core.cache.map.DoubleDoor;
...
import dcrew.core.task.impl.HarvestTask;
import dcrew.core.task.impl.HopDitchTask;
import dcrew.core.task.impl.ObeliskTick;
import dcrew.core.task.impl.PullLeverTask;
import dcrew.core.task.impl.ShearingTask;
import dcrew.core.task.impl.TeleOtherTask;
import dcrew.core.task.impl.WalkThroughDoorTask;
import dcrew.core.task.impl.WalkThroughDoubleDoorTask;
import dcrew.core.task.impl.WalkToTask;
import dcrew.core.util.GameDefinitionLoader;
import dcrew.core.util.Utility;
import dcrew.rs2.content.CrystalChest;
import dcrew.rs2.content.DropTable;
import dcrew.rs2.content.FountainOfRune;
import dcrew.rs2.content.Prestige;
import dcrew.rs2.content.achievements.AchievementHandler;
import dcrew.rs2.content.achievements.AchievementList;
...
import dcrew.rs2.content.dialogue.impl.AchievementDialogue;
import dcrew.rs2.content.dialogue.impl.AdamDialogue;
import dcrew.rs2.content.dialogue.impl.BigMoDialogue;
import dcrew.rs2.content.dialogue.impl.DecantingDialogue;
import dcrew.rs2.content.dialogue.impl.DunceDialogue;
import dcrew.rs2.content.dialogue.impl.EmblemDialogue;
import dcrew.rs2.content.dialogue.impl.FiremakingDialogue;
import dcrew.rs2.content.dialogue.impl.GamblerDialogue;
import dcrew.rs2.content.dialogue.impl.GenieResetDialogue;
import dcrew.rs2.content.dialogue.impl.HariDialogue;
import dcrew.rs2.content.dialogue.impl.KamfreeDialogue;
import dcrew.rs2.content.dialogue.impl.KolodionDialogue;
import dcrew.rs2.content.dialogue.impl.MakeoverMage;
import dcrew.rs2.content.dialogue.impl.MembershipDialogue;
import dcrew.rs2.content.dialogue.impl.NeiveDialogue;
import dcrew.rs2.content.dialogue.impl.OttoGodblessed;
import dcrew.rs2.content.dialogue.impl.OziachDialogue;
import dcrew.rs2.content.dialogue.impl.PilesDialogue;
import dcrew.rs2.content.dialogue.impl.PrestigeDialogue;
import dcrew.rs2.content.dialogue.impl.RunecraftingTeleport;
import dcrew.rs2.content.dialogue.impl.SailorDialogue;
import dcrew.rs2.content.dialogue.impl.SecurityDialogue;
import dcrew.rs2.content.dialogue.impl.ShopExchangeDialogue;
import dcrew.rs2.content.dialogue.impl.ShopExchangeDialogue2;
import dcrew.rs2.content.dialogue.impl.StaffTitleDialogue;
import dcrew.rs2.content.dialogue.impl.TzhaarMejKahDialogue;
import dcrew.rs2.content.dialogue.impl.VannakaDialogue;
import dcrew.rs2.content.dialogue.impl.WeaponGameDialogue;
import dcrew.rs2.content.dialogue.impl.teleport.SpiritTree;
import dcrew.rs2.content.dialogue.impl.teleport.WildernessLever;
import dcrew.rs2.content.dwarfcannon.DwarfMultiCannon;
import dcrew.rs2.content.membership.MysteryBoxMinigame;
import dcrew.rs2.content.minigames.barrows.Barrows;
import dcrew.rs2.content.minigames.clanwars.ClanWarsFFA;
import dcrew.rs2.content.minigames.fightcave.TzharrGame;
import dcrew.rs2.content.minigames.fightpits.FightPits;
import dcrew.rs2.content.minigames.godwars.GodWars;
import dcrew.rs2.content.minigames.pestcontrol.PestControl;
import dcrew.rs2.content.minigames.plunder.PyramidPlunder;
import dcrew.rs2.content.minigames.warriorsguild.ArmourAnimator;
import dcrew.rs2.content.minigames.warriorsguild.CyclopsRoom;
import dcrew.rs2.content.minigames.weapongame.WeaponGame;
import dcrew.rs2.content.minigames.weapongame.WeaponGameStore;
import dcrew.rs2.content.pets.BossPets;
import dcrew.rs2.content.pets.BossPets.PetData;
import dcrew.rs2.content.shopping.impl.BountyShop;
import dcrew.rs2.content.shopping.impl.PestShop;
import dcrew.rs2.content.skill.Skills;
import dcrew.rs2.content.skill.agility.Agility;
import dcrew.rs2.content.skill.agility.obstacle.interaction.WalkInteraction;
import dcrew.rs2.content.skill.cooking.CookingTask;
import dcrew.rs2.content.skill.crafting.CraftingType;
import dcrew.rs2.content.skill.crafting.Flax;
import dcrew.rs2.content.skill.crafting.HideTanning;
import dcrew.rs2.content.skill.crafting.JewelryCreationTask;
import dcrew.rs2.content.skill.crafting.Spinnable;
import dcrew.rs2.content.skill.farming.Farming;
import dcrew.rs2.content.skill.firemaking.FireColor;
import dcrew.rs2.content.skill.herblore.PotionDecanting;
import dcrew.rs2.content.skill.hunter.Impling.ImplingRewards.Implings;
import dcrew.rs2.content.skill.magic.MagicSkill;
import dcrew.rs2.content.skill.magic.MagicSkill.SpellBookTypes;
import dcrew.rs2.content.skill.mining.Mining;
import dcrew.rs2.content.skill.prayer.BoneBurying;
import dcrew.rs2.content.skill.runecrafting.AbyssObjects;
import dcrew.rs2.content.skill.runecrafting.RunecraftingTask;
import dcrew.rs2.content.skill.smithing.SmithingConstants;
import dcrew.rs2.content.skill.thieving.HomeStalls;
import dcrew.rs2.content.skill.thieving.ThievingNpcTask;
import dcrew.rs2.content.skill.thieving.ThievingStallTask;
import dcrew.rs2.content.skill.thieving.WallSafes;
import dcrew.rs2.content.skill.woodcutting.WoodcuttingTask;
import dcrew.rs2.content.wilderness.Lockpick;
import dcrew.rs2.content.wilderness.TargetSystem;
import dcrew.rs2.entity.item.Item;
import dcrew.rs2.entity.item.ItemCheck;
...
public class WalkToActions {
	...
	public final static String[] DEFAULT_DIALOGUES = { "When you feel sad, just sing Roar - by Katy Perry!", "Thank the " + Constants.name + " gods for this beautiful day!", "Break free of your cage and be happy!", "Porn is the key to a happy marriage.", "I'm in the mood to groove it out!", "Don't let fear hold you down.", "Just let it out, let it out.", "Make your dreams a reality.", "Be your own creator.", "Daniel blesses your soul." };
	...
	public static void finishObjectClick(Player player, int id, int option, int x, int y) {
		...
		case 1:
			...
			if (id == 8720 || id == 26820 || id == 26813) {
				player.send(new SendString((Constants.website + "/vote/"), 12000));
