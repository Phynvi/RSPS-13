...
import dcrew.rs2.content.interfaces.impl.ModCommandsInterface;
...
import dcrew.rs2.entity.player.net.out.impl.SendSystemBan;
...
public class ModeratorCommand implements Command {
	...
	public boolean handleCommand(Player player, CommandParser parser) throws Exception {
		...
		case "modcommands":
		case "modcommand":
			player.send(new SendString(Constants.name + " Mod Command List", 8144));
	...
	@Override
	public boolean meetsRequirements(Player player) { return player.getRights() >= 1 && player.getRights() < 5; }
}