...
import dcrew.rs2.entity.player.net.in.impl.BankAllButOne;
import dcrew.rs2.entity.player.net.in.impl.BankModifiableX;
import dcrew.rs2.entity.player.net.in.impl.ChangeAppearancePacket;
import dcrew.rs2.entity.player.net.in.impl.ChangeRegionPacket;
import dcrew.rs2.entity.player.net.in.impl.ChatInterfacePacket;
import dcrew.rs2.entity.player.net.in.impl.ClickButtonPacket;
import dcrew.rs2.entity.player.net.in.impl.CloseInterfacePacket;
import dcrew.rs2.entity.player.net.in.impl.FlashingSideIconPacket;
import dcrew.rs2.entity.player.net.in.impl.InputFieldPacket;
import dcrew.rs2.entity.player.net.in.impl.InterfaceAction;
import dcrew.rs2.entity.player.net.in.impl.ItemPackets;
import dcrew.rs2.entity.player.net.in.impl.MovementPacket;
import dcrew.rs2.entity.player.net.in.impl.NPCPacket;
import dcrew.rs2.entity.player.net.in.impl.ObjectPacket;
import dcrew.rs2.entity.player.net.in.impl.PlayerOptionPacket;
import dcrew.rs2.entity.player.net.in.impl.PrivateMessagingPacket;
import dcrew.rs2.entity.player.net.in.impl.PublicChatPacket;
import dcrew.rs2.entity.player.net.in.impl.ReceiveString;
import dcrew.rs2.entity.player.net.in.impl.ResetCounter;
import dcrew.rs2.entity.player.net.in.impl.SpawnTab;
import dcrew.rs2.entity.player.net.in.impl.StringInputPacket;
...
public class PacketHandler {
	...
	private static final IncomingPacket commandPacket = new Commands();
