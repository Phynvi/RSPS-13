...
import dcrew.TeleportMenu;
import dcrew.core.network.StreamBuffer;
import dcrew.core.util.Utility;
import dcrew.rs2.content.DropTable;
import dcrew.rs2.content.EasterRing;
import dcrew.rs2.content.Emotes;
import dcrew.rs2.content.GenieLamp;
import dcrew.rs2.content.GenieReset;
import dcrew.rs2.content.LoyaltyShop;
import dcrew.rs2.content.PlayersOnline;
import dcrew.rs2.content.Prestige;
import dcrew.rs2.content.SkillsChat;
import dcrew.rs2.content.StarterKit;
import dcrew.rs2.content.achievements.AchievementButtons;
import dcrew.rs2.content.combat.formula.MagicFormulas;
import dcrew.rs2.content.combat.formula.MeleeFormulas;
import dcrew.rs2.content.combat.formula.RangeFormulas;
...
import dcrew.rs2.content.interfaces.impl.AchievementTab;
import dcrew.rs2.content.interfaces.impl.PointsInterface;
import dcrew.rs2.content.interfaces.impl.QuestTab;
import dcrew.rs2.content.membership.CreditHandler;
...
import dcrew.rs2.content.profiles.ProfileLeaderboard;
import dcrew.rs2.content.skill.SkillGoal;
...
import dcrew.rs2.content.skill.crafting.Crafting;
import dcrew.rs2.content.skill.crafting.HideTanning;
import dcrew.rs2.content.skill.firemaking.FireColor;
import dcrew.rs2.content.skill.fletching.Fletching;
import dcrew.rs2.content.skill.herblore.HerbloreFinishedPotionTask;
import dcrew.rs2.content.skill.herblore.HerbloreUnfinishedPotionTask;
import dcrew.rs2.content.skill.magic.Autocast;
import dcrew.rs2.content.skill.magic.MagicSkill.TeleportTypes;
import dcrew.rs2.content.skill.magic.spells.BoltEnchanting;
...
import dcrew.rs2.content.skill.summoning.SummoningCreation;
import dcrew.rs2.entity.Animation;
import dcrew.rs2.entity.Graphic;
import dcrew.rs2.entity.ReportHandler;
import dcrew.rs2.entity.ReportHandler.ReportData;
...
import dcrew.rs2.entity.player.net.out.impl.SendOpenTab;
...
public class ClickButtonPacket extends IncomingPacket {
	...
	public void handle(Player player, StreamBuffer.InBuffer in, int opcode, int length) {
		...
		if ((player.isDead()) || (!player.getController().canClick()))
			return;
		if (TeleportMenu.isTPButton(buttonId)) {
			TeleportMenu.setTeleport(buttonId, player);
			return;
		}
		...
		case 114229:
			if (PlayerConstants.isStaff(player)) {		
				...
				if (PlayerConstants.isMod(player))
					accessibility = "You have access to a few commands!";
				else if (PlayerConstants.isAdmin(player))
		...
		case 66108:
			...
			break;
		case 66115:
			player.send(new SendString(Constants.website + "/store/", 12000));
			break;
		/** Drop Table */
		case 233110:
		...
		case 50235:
		case 4140:
			TeleportMenu.setTab(0, player);
			break;
		case 50245:
		case 4143:
			TeleportMenu.setTab(1, player);
			break;
		case 50253:
		case 4146:
			TeleportMenu.setTab(2, player);
			break;
		case 51005:
		case 4150:
			TeleportMenu.setTab(3, player);
			break;
		case 51013:
		case 6004:
			TeleportMenu.setTab(4, player);
			break;
		case 51023:
		case 6005:
			TeleportMenu.setTab(5, player);
			break;
		...
		default:
			...
			if (Fletching.SINGLETON.clickButton(player, buttonId))
				break;
			if (dcrew.rs2.content.skill.craftingnew.Crafting.SINGLETON.clickButton(player, buttonId))
				break;
