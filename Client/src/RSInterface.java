		...
		while (stream.currentOffset < stream.buffer.length) {
			...
			if (rsInterface.type == 2) {
				...
				for (int l3 = 0; l3 < 5; l3++) {
					...
					else if (rsInterface.parentID == 3822)
						rsInterface.actions[4] = "Sell X";
					else if (rsInterface.parentID == 1644)
			...
			if (rsInterface.type == 4) {
				rsInterface.disabledMessage = stream.readString().replaceAll("RuneScape", "" + ClientConstants.name);
